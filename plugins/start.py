...
async def start(client, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton(" Developer ", url='https://t.me/King1_devil')
        ],[
        InlineKeyboardButton(' Updates', url='https://t.me/SUMIT_KING_2'),
        InlineKeyboardButton(' Support', url='https://t.me/King1_devil')
        ],[
        InlineKeyboardButton(' About', callback_data='about'),
        InlineKeyboardButton(' Help', callback_data='help')
        ],[
        InlineKeyboardButton(" Join Our Movie Channel !", url='https://t.me/SUMIT_KING_2')
        ],[
        InlineKeyboardButton("❤️ Subscribe YT ❤️", url='https://www.youtube.com/@kajal')
        ]
        ])
    if START_PIC:
